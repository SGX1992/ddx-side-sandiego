import { EVENTS } from './events.js?v=20260912211001';
import { SUBMIT_ENDPOINT, POSTER_URL } from './config.js?v=20260912211001';
import { VIP, MIAMI, SITE, CITY, COPY } from './variant.js?v=20260912211001';
import { cardHTML } from './render.js?v=20260912211001';
...
const ALL = MIAMI
  ? (await import('./events-miami.js?v=20260912211001')).MIAMI_EVENTS
  : VIP ? [...(await import('./events-vip.js?v=20260912211001')).VIP_EVENTS, ...EVENTS] : EVENTS;
